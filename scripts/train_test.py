    ...
    for epoch in range(start_epoch, end_of_epochs):
        ...
        # ###Starting the iterations##################
            ...
            if phase == 'train':
                ...
                AP_val = pd.DataFrame(AP, columns=['Name_VAL',
                        'Score_VAL'])
    ...
    # ####################################
        ...
        if infr == 't':
            ...
            AP_final_single = pd.concat([AP_train_single,
                    AP_val_single, AP_test_single], axis=1)
        ...
        try:
            print('Loss_train:{},Loss_validation:{},Loss_test:{}'.format(loss_epoch_train[epoch
                    - start_epoch], loss_epoch_val[epoch
