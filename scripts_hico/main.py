...
from dataloader_hico import Rescale, ToTensor, hico_Dataset, \
    hico_collate
...
annotation_test = all_data_dir \
    + 'Annotations_hico/test_annotations.json'
...
lambda1 = lambda epoch: (1.0 if epoch < 10 else (0.1 if epoch
                         < 28 else 1))
